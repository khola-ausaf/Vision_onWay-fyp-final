...
class LDay3_Exercises extends StatefulWidget {
  const LDay3_Exercises({Key? key}) : super(key: key);

  @override
  State<LDay3_Exercises> createState() => _LDay3_ExercisesState();
}

// ignore: camel_case_types
class _LDay3_ExercisesState extends State<LDay3_Exercises> {
  ...
  void initState() {
    ...
    const url = 'https://youtu.be/O7f5EMqrYWg';

...
class LDay6_Exercises extends StatefulWidget {
  const LDay6_Exercises({Key? key}) : super(key: key);

  @override
  State<LDay6_Exercises> createState() => _LDay6_ExercisesState();
}

// ignore: camel_case_types
class _LDay6_ExercisesState extends State<LDay6_Exercises> {
  ...
  void initState() {
    ...
    const url = 'https://youtu.be/nNfykfGe6MI';
